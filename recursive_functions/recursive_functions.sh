...
if [ "$output" == "$expected_output" ] ; then
    echo -e "\033[0;32m u'\u2714' Pass:\033[0m The program computed the correct output for $num1 choose $num2."
else
    echo -e "\033[0;31m u'\u2718' Fail:\033[0m Expected '$expected_output' but got: $output"
    exit 1
fi
}
